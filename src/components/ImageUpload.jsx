...
const ImageUpload = ({ getImageData, theme }) => {
        ...
        >
            {uploadProgress === 0 && !imageData ? (
                <>
                    ...
                    {theme == 'small' ? (
                        <div
                            className="h-12 w-72 flex items-center justify-between cursor-pointer border border-background bg-white rounded-lg shadow-md hover:bg-gray-50 overflow-hidden"
                            onClick={(e) => {
                                e.preventDefault();
                        ...
                        >
                            ...
                            <div className="h-full p-2 flex items-center justify-center border-l text-primary bg-main hover:bg-primary hover:text-background">
                                <span className="text-center uppercase text-sm">
                                    upload
                                </span>
                            </div>
                        </div>
