...
export const Timeline = () => {
    ...
    return (
        event?.timeline && (
            <div className="min-h-fit w-full" id="timeline">
                <div
                    ref={containerRef}
                ...
                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10 flex flex-col justify-center items-center">
                        ...
                        <p className="text-neutral-400 text-sm md:text-lg text-center max-w-2xl mx-auto mb-6">
                            This is the detailed timeline of the Ideathon. It
                            will span across multiple days, with clear
                            milestones for submissions, evaluations, and final
                            presentations. Please review the schedule carefully
                            to stay on track.
                        </p>
                    </div>
