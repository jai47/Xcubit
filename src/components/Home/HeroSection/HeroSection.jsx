        ...
        >
            ...
            <div className="w-full h-full flex flex-col lg:flex-row items-center justify-center gap-8 px-4 lg:px-16 text-center lg:text-left lg:mt-12">
                ...
                <div className="flex flex-col items-center lg:items-start max-w-2xl">
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-sans font-medium tracking-wide captilize">
                        Xcubiton
                    </h1>
                    ...
                    <HeroTimeRemaining
                        data={new Date('2026-09-25T09:30:00')}
                ...
                <div className="flex-shrink-0 w-full max-w-xl mt-8 lg:mt-0">
                    <VideoPlayer
                        thumbnailUrl="https://res.cloudinary.com/dql4uvrzz/image/upload/v1733043806/awards/huqoicsb7thsfppjsn1p.png"
                        videoUrl="https://res.cloudinary.com/dql4uvrzz/video/upload/v1732974634/hsdpte3zjn7aja6s0gv3.mp4"
                        title="Building the Future"
                        description="A look into modern era and design."
