          ...
          rounded-md overflow-hidden flex items-center`}
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-10 lg:gap-16 w-full text-center lg:text-left mt-16 sm:mt-20 lg:mt-24">
                ...
                <div className="flex flex-col items-center lg:items-start max-w-2xl px-2 sm:px-6">
                    <h1
                        ref={headingRef}
                        className="text-5xl md:text-5xl lg:text-6xl font-sans font-medium tracking-wide capitalize leading-tight"
                    >
                ...
                {/* Right Section (Video) */}
                <div className="flex-shrink-0 w-full sm:w-4/5 md:w-3/4 lg:w-[45%] mt-6 lg:mt-0 hidden md:block lg:block">
                    <VideoPlayer
