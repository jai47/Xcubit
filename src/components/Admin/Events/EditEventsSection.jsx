...
const EditEventsSection = ({ event, back }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        featureGuests: event.featureGuests,
    });
    ...
    return (
        <>
            <div className="absolute h-[850px] w-full bg-gray-100 flex flex-col items-center overflow-y-auto">
                <div
                    className="absolute top-3 left-3 bg-gray-200 rounded-full cursor-pointer"
                    onClick={back}
                >
                    <MdKeyboardArrowLeft size={35} />
                </div>
                {/* Page Title */}
                <div className="w-4/5 mb-6 flex items-center justify-start">
...
export default EditEventsSection;
