...
const SupportersSection = () => {
    ...
    return (
        <section className="py-12 text-center w-full flex justify-center items-center bg-gray-50">
            <div className="w-4/5 flex flex-col justify-center items-center gap-10 mb-16">
